...
Original file is located at
    https://colab.research.google.com/drive/1sfrJI7wNzYtiHn89-Fl4smGsrYlqSfNn
"""
...
def generateResults(input_file:str='Validation_Dataset_10.xlsx'):
  data=pd.read_excel(input_file,engine='openpyxl',usecols='A,B,C,D,E')
  print(data.shape)
